...
export const CARDS: Card[] = [
  ...
  wizard(4, 'Wizard Healer', 'Healer', 'No player can steal a hero from your party', '/cards/wizard_healer.png'),
  wizard(5, 'Wizard Healer', 'Healer', 'No player can steal a hero from your party', '/cards/wizard_healer.png'),
  wizard(6, 'Wizard Healer', 'Healer', 'No player can steal a hero from your party', '/cards/wizard_healer.png'),
  wizard(7, 'Wizard Spellcaster', 'Spellcaster', 'You only need 5 matching skills to play a Quest Card', '/cards/wizard_spellcaster.png'),
  wizard(8, 'Wizard Spellcaster', 'Spellcaster', 'You only need 5 matching skills to play a Quest Card', '/cards/wizard_spellcaster.png'),
  wizard(9, 'Wizard Spellcaster', 'Spellcaster', 'You only need 5 matching skills to play a Quest Card', '/cards/wizard_spellcaster.png'),
  wizard(10, 'Wizard Stargazer', 'Stargazer', 'You can play 2 cards in one turn', '/cards/wizard_stargazer.png'),
  wizard(11, 'Wizard Stargazer', 'Stargazer', 'You can play 2 cards in one turn', '/cards/wizard_stargazer.png'),
  wizard(12, 'Wizard Stargazer', 'Stargazer', 'You can play 2 cards in one turn', '/cards/wizard_stargazer.png'),
  wizard(13, 'Wizard Summoner', 'Summoner', 'As a turn, you can draw any one card from the event pile', '/cards/wizard_summoner.png'),
  wizard(14, 'Wizard Summoner', 'Summoner', 'As a turn, you can draw any one card from the event pile', '/cards/wizard_summoner.png'),
  wizard(15, 'Wizard Summoner', 'Summoner', 'As a turn, you can draw any one card from the event pile', '/cards/wizard_summoner.png'),
  ...
  hero(50, 'Stefan Swifthand', 'Thief', ['Fast', 'Fast'], '/cards/thief_stefan_FF.png'),
  hero(51, "Lady O'Faun", 'Thief', ['Strong', 'Magic', 'Magic'], '/cards/thief_lady_SMM.png'),
  hero(52, 'Kara Karslashian', 'Knight', ['Strong', 'Strong'], '/cards/knight_kara_SS.png'),
  hero(53, 'Morvin the Mugger', 'Thief', ['Strong', 'Strong', 'Fast'], '/cards/thief_morvin_SSF.png'),
  ...
  hero(64, 'Brobo Pockpickins', 'Thief', ['Sturdy', 'Sturdy', 'Fast'], '/cards/thief_brobo_UUF.png'),
